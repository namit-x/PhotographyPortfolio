...
const testimonials: Testimonial[] = [
  {
    ...
    role: "Wedding Couple",
    text: "Meenakshi Studio captured our wedding day with such artistry and emotion. Every photograph tells our love story perfectly. The team was professional, creative, and made us feel so comfortable throughout the entire process.",
  ...
  },
  {
    ...
    name: "Meera Patel",
    role: "Bride",
    text: "The portrait session was absolutely magical! The team has an incredible eye for capturing the perfect moments. The lighting, composition, and overall aesthetic exceeded all my expectations. Highly recommend!",
  ...
  },
  {
    ...
    text: "For our 10th anniversary, we wanted something special. Meenakshi Studio delivered beyond our dreams. The creative vision and attention to detail in every shot was remarkable. We treasure these memories forever.",
  ...
  },
  {
    ...
    name: "Vikram Singh",
    role: "Groom",
    text: "Professional, creative, and incredibly talented! The engagement photos turned out better than we ever imagined. There artistic vision and technical expertise created memories we'll cherish forever.",
  ...
  },
  {
    ...
    name: "Deepika & Rohit",
    role: "Wedding Couple",
    text: "From our pre-wedding shoot to the reception, every moment was captured with perfection. The team's creativity and professionalism made our special day even more memorable. Absolutely recommend Meenakshi Studio!",
