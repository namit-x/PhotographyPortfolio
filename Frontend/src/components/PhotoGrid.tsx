    ...
    <section className="relative py-20 px-4 bg-gradient-to-br from-gray-50 via-white to-pink-50/30 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10" ref={containerRef}>
        ...
        >
          ...
          >
            Every celebration tells a story. From intimate moments to grand celebrations,
            we capture the essence of your most precious memories.
          </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="flex flex-col">
            ...
            >
              <motion.button
                className="group relative w-full m-[150px] px-8 py-4 bg-white border border-pink-200 text-gray-800 rounded-2xl font-medium text-lg tracking-wide shadow-lg hover:shadow-xl transition-all duration-300"
                whileHover={{
                  scale: 1.05,
